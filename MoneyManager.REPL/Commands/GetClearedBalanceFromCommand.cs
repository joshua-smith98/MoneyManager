...
{
    internal class GetClearedBalanceFromCommand(Command[] pathToThisCommand) : Command(pathToThisCommand)
    {
        public override string Str => "from";

        public override string About => "Gets the cleared balance for the current context, for the given period from the given date.";
        ...
        protected override Action<ArgumentValueCollection>? Action =>
            (ArgumentValueCollection args) =>
            {
                ...
                Terminal.MessageSingle(balanceable.BalanceInfoForPeriod(fromDate, getPeriod).ClearedBalance);
            };
    }
}
