...
namespace MoneyManager.REPL.Commands
{
    internal class GetClearedIncomeFromCommand(Command[] pathToThisCommand) : Command(pathToThisCommand)
    {
        ...
        public override string About => "Gets the cleared income for the current context, for the given period from the given date.";
        ...
        protected override Action<ArgumentValueCollection>? Action =>
            (ArgumentValueCollection args) =>
            {
                ...
                Terminal.MessageSingle(balanceable.BalanceInfoForPeriod(fromDate, getPeriod).ClearedIncome);
            };
    }
}
