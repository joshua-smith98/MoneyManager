...
{
    internal class GetExpensesFromCommand(Command[] pathToThisCommand) : Command(pathToThisCommand)
    {
        public override string Str => "from";

        public override string About => "Gets the total expenses for the current context, for the given period from the given date.";
        ...
        protected override Action<ArgumentValueCollection>? Action =>
            (ArgumentValueCollection args) =>
            {
                ...
                Terminal.MessageSingle(balanceable.BalanceInfoForPeriod(fromDate, getPeriod).Expenses);
            };
    }
}
